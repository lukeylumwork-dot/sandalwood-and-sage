...
const navLinks: { label: string; href: string; route?: boolean }[] = [
  ...
  { label: "All Episodes", href: "/episodes", route: true },
      ...
      <div className="grid gap-10 sm:gap-8 md:grid-cols-3">
        ...
        <div className="flex flex-col gap-3">
          <a href="/" aria-label="Sandalwood & Sage home">
            <img src={logo} alt="Sandalwood & Sage" width={78} height={28} className="h-7 w-auto block dark:hidden" />
            <img src={logoBrand} alt="Sandalwood & Sage" width={78} height={28} className="h-7 w-auto hidden dark:block" />
          </a>
