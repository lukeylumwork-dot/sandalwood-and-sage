...
```sh
VITE_SUPABASE_URL="https://svtwzufbwajdolcgdqdf.supabase.co"
...
SUPABASE_URL="https://svtwzufbwajdolcgdqdf.supabase.co"
...
3. Link to the Supabase project if needed:
   ...
   ```sh
   supabase link --project-ref svtwzufbwajdolcgdqdf
   ```
...
5. Set Supabase Edge Function secrets:
   ...
   supabase secrets set SUPABASE_URL="https://svtwzufbwajdolcgdqdf.supabase.co"
...
- Open `https://svtwzufbwajdolcgdqdf.supabase.co/functions/v1/rss-feed`. Confirm XML loads publicly and includes `<item>`, `<guid>`, `<link>`, and `<enclosure>` for episodes with audio.
